...
Usage:
    ...
    # 'block' is the entire HTTP request or response, including headers
    # To create a request record:
    record = warcrecords.WarcRequestRecord(url=url, block=block)
    warcrecords.WarcOutputSingleton().write_record(record)
    
    # To create a response record:
